...
class src_spell(src_object):
    ...
    fire_spell=spell('Fire Spell',3,description='Two chances to damage opponent; Uses 3 stamina',element='fire')
    ...
    tsunami_spell=spell('Tsunami Spell',10,1,'Unleash a wave of damage on an enemy\nDamage is a random number between 1 and 6\ntimes a random number between 1 and 3',element='water')
